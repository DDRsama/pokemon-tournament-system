...
- `beta`：测试版 Docker 镜像
- 形如 `3.3.2-beta` 的 tag：具体 beta 版本镜像
- 形如 `3.3.2` 的 tag：具体稳定版镜像
...
```bash
docker pull ddrsama/pokemon-tournament-system:3.3.2
```
...
```bash
PTS_TAG=3.3.2 docker compose -f docker-compose.deploy.yml up -d
```
